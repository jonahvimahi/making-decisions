...
// Subscripting (accessing values using their index) an array can fail. What happens if you subscript to the 7th element, but there are not 7 elements in the array? Let's write some code to 
// check for that. 
...
switch(letterGrade) {
  ...
  case 'B' :
    ...
    break;
  case 'A' :
    console.log('The student is doing escellently')
    break;
  default:
